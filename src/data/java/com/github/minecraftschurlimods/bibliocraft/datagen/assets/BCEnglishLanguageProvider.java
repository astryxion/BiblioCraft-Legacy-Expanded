...
public class BCEnglishLanguageProvider extends LanguageProvider {
    ...
    private static String tagKeyToTranslationKey(String type, ResourceLocation loc) {
        return "tag." + type + "." + loc.getNamespace() + "." + loc.getPath().replace("/", ".");
    }
    ...
    protected void addTranslations() {
        ...
        addBlockTag(BCTags.Blocks.BOOKCASES, "Bookcases");
        addBlockTag(BCTags.Blocks.DISPLAY_CASES, "Display Cases");
        addBlockTag(BCTags.Blocks.FANCY_ARMOR_STANDS_WOOD, "Wooden Fancy Armor Stands");
        addBlockTag(BCTags.Blocks.FANCY_ARMOR_STANDS, "Fancy Armor Stands");
        addBlockTag(BCTags.Blocks.FANCY_CLOCKS, "Fancy Clocks");
        addBlockTag(BCTags.Blocks.FANCY_SIGNS, "Fancy Signs");
        addBlockTag(BCTags.Blocks.GRANDFATHER_CLOCKS, "Grandfather Clocks");
        addBlockTag(BCTags.Blocks.LABELS, "Labels");
        addBlockTag(BCTags.Blocks.POTION_SHELVES, "Potion Shelves");
        addBlockTag(BCTags.Blocks.PRINTING_TABLES, "Printing Tables");
        addBlockTag(BCTags.Blocks.SEATS, "Seats");
        addBlockTag(BCTags.Blocks.SEAT_BACKS, "Seat Backs");
        addBlockTag(BCTags.Blocks.SHELVES, "Shelves");
        addBlockTag(BCTags.Blocks.TABLES, "Tables");
        addBlockTag(BCTags.Blocks.TOOL_RACKS, "Tool Racks");
        addBlockTag(BCTags.Blocks.FANCY_LAMPS, "Fancy Lamps");
        addBlockTag(BCTags.Blocks.FANCY_LAMPS_GOLD, "Gold Fancy Lamps");
        addBlockTag(BCTags.Blocks.FANCY_LAMPS_IRON, "Iron Fancy Lamps");
        addBlockTag(BCTags.Blocks.FANCY_LANTERNS, "Fancy Lanterns");
        addBlockTag(BCTags.Blocks.FANCY_LANTERNS_GOLD, "Gold Fancy Lanterns");
        addBlockTag(BCTags.Blocks.FANCY_LANTERNS_IRON, "Iron Fancy Lanterns");
        addBlockTag(BCTags.Blocks.TYPEWRITERS, "Typewriters");
        addItemTag(BCTags.Items.BOOKCASES, "Bookcases");
        addItemTag(BCTags.Items.DISPLAY_CASES, "Display Cases");
        addItemTag(BCTags.Items.FANCY_ARMOR_STANDS_WOOD, "Wooden Fancy Armor Stands");
        addItemTag(BCTags.Items.FANCY_ARMOR_STANDS, "Fancy Armor Stands");
        addItemTag(BCTags.Items.FANCY_CLOCKS, "Fancy Clocks");
        addItemTag(BCTags.Items.FANCY_SIGNS, "Fancy Signs");
        addItemTag(BCTags.Items.GRANDFATHER_CLOCKS, "Grandfather Clocks");
        addItemTag(BCTags.Items.LABELS, "Labels");
        addItemTag(BCTags.Items.POTION_SHELVES, "Potion Shelves");
        addItemTag(BCTags.Items.PRINTING_TABLES, "Printing Tables");
        addItemTag(BCTags.Items.SEATS, "Seats");
        addItemTag(BCTags.Items.SEAT_BACKS, "Seat Backs");
        addItemTag(BCTags.Items.SHELVES, "Shelves");
        addItemTag(BCTags.Items.TABLES, "Tables");
        addItemTag(BCTags.Items.TOOL_RACKS, "Tool Racks");
        addItemTag(BCTags.Items.FANCY_LAMPS, "Fancy Lamps");
        addItemTag(BCTags.Items.FANCY_LAMPS_GOLD, "Gold Fancy Lamps");
        addItemTag(BCTags.Items.FANCY_LAMPS_IRON, "Iron Fancy Lamps");
        addItemTag(BCTags.Items.FANCY_LANTERNS, "Fancy Lanterns");
        addItemTag(BCTags.Items.FANCY_LANTERNS_GOLD, "Gold Fancy Lanterns");
        addItemTag(BCTags.Items.FANCY_LANTERNS_IRON, "Iron Fancy Lanterns");
        addItemTag(BCTags.Items.TYPEWRITERS, "Typewriters");
        addItemTag(BCTags.Items.BOOKCASE_BOOKS, "Books for Bookcases");
        addItemTag(BCTags.Items.COOKIE_JAR_COOKIES, "Cookies for Cookie Jars");
        addItemTag(BCTags.Items.DISC_RACK_DISCS, "Discs for Disc Racks");
        addItemTag(BCTags.Items.FANCY_SIGN_WAX, "Wax for Fancy Signs");
        addItemTag(BCTags.Items.POTION_SHELF_POTIONS, "Potions for Potion Shelves");
        addItemTag(BCTags.Items.SWORD_PEDESTAL_SWORDS, "Swords for Sword Pedestals");
        addItemTag(BCTags.Items.TOOL_RACK_TOOLS, "Tools for Tool Racks");
        addItemTag(BCTags.Items.TYPEWRITER_PAPER, "Paper for Typewriters");
        addEnchantmentTag(BCTags.Enchantments.PRINTING_TABLE_CLONING_BLACKLIST, "Printing Table Cloning Blacklist");
        ...
        add(Translations.VANILLA_TOGGLABLE_SLOT_KEY, "Click to disable slot");
    }
     ...
     */
    private void addDefaultBlock(RegistryObject<? extends Block> block) {
     ...
     */
    private void addDefaultItem(RegistryObject<? extends Item> item) {
