...
public final class BCDatagen implements DataGeneratorEntrypoint {
    ...
    public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator) {
        gatherData(fabricDataGenerator, fabricDataGenerator.getRegistries());
    }

    @SubscribeEvent
    private static void gatherData(GatherDataEvent.Client event) {
        gatherData(event.getGenerator(), event.getLookupProvider());
    }

    private static void gatherData(DataGenerator generator, CompletableFuture<HolderLookup.Provider> lookupProvider) {
