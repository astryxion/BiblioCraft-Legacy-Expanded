...
public interface BCBlocks {
    ...
    FabricRegistrar.RegistryRef<Block>     CLEAR_FANCY_GOLD_LAMP = BCRegistries.BLOCKS.register("fancy_gold_lamp", () -> new FancyLampBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    ...
    FabricRegistrar.RegistryRef<Block>     CLEAR_FANCY_IRON_LAMP = BCRegistries.BLOCKS.register("fancy_iron_lamp", () -> new FancyLampBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    ...
    FabricRegistrar.RegistryRef<Block>     CLEAR_FANCY_GOLD_LANTERN = BCRegistries.BLOCKS.register("fancy_gold_lantern",        () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    ...
    FabricRegistrar.RegistryRef<Block>     SOUL_FANCY_GOLD_LANTERN = BCRegistries.BLOCKS.register("soul_fancy_gold_lantern",   () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 10 : 0).noOcclusion(), BCUtil.modLoc("buzzier_bees", "small_soul_fire_flame")));
    FabricRegistrar.RegistryRef<Block>     CLEAR_FANCY_IRON_LANTERN = BCRegistries.BLOCKS.register("fancy_iron_lantern",        () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    ...
    FabricRegistrar.RegistryRef<Block>     SOUL_FANCY_IRON_LANTERN = BCRegistries.BLOCKS.register("soul_fancy_iron_lantern",   () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 10 : 0).noOcclusion(), BCUtil.modLoc("buzzier_bees", "small_soul_fire_flame")));
    FabricRegistrar.RegistryRef<Block>     CLEAR_TYPEWRITER = BCRegistries.BLOCKS.register("typewriter", () -> new TypewriterBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TERRACOTTA).noOcclusion()));
    ...
    FabricRegistrar.RegistryRef<Block>   COOKIE_JAR             = BCRegistries.BLOCKS.register("cookie_jar",             () -> new CookieJarBlock      (BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS)));
    FabricRegistrar.RegistryRef<Block>   CLIPBOARD              = BCRegistries.BLOCKS.register("clipboard",              () -> new ClipboardBlock      (BlockBehaviour.Properties.of().instabreak().sound(SoundType.WOOD).ignitedByLava()));
    FabricRegistrar.RegistryRef<Block>   DESK_BELL              = BCRegistries.BLOCKS.register("desk_bell",              () -> new DeskBellBlock       (BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion()));
    FabricRegistrar.RegistryRef<Block>   DINNER_PLATE           = BCRegistries.BLOCKS.register("dinner_plate",           () -> new DinnerPlateBlock    (BlockBehaviour.Properties.ofFullCopy(Blocks.SMOOTH_QUARTZ).noOcclusion()));
    FabricRegistrar.RegistryRef<Block>   DISC_RACK              = BCRegistries.BLOCKS.register("disc_rack",              () -> new DiscRackBlock       (BlockBehaviour.Properties.ofFullCopy(Blocks.JUKEBOX).noOcclusion()));
    FabricRegistrar.RegistryRef<Block>   WALL_DISC_RACK         = BCRegistries.BLOCKS.register("wall_disc_rack",         () -> new WallDiscRackBlock   (BlockBehaviour.Properties.ofFullCopy(Blocks.JUKEBOX).noOcclusion()));
    FabricRegistrar.RegistryRef<Block>   IRON_FANCY_ARMOR_STAND = BCRegistries.BLOCKS.register("iron_fancy_armor_stand", () -> new FancyArmorStandBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion()));
    FabricRegistrar.RegistryRef<Block>   GOLD_CHAIN             = BCRegistries.BLOCKS.register("gold_chain",             () -> new ChainBlock          (BlockBehaviour.Properties.ofFullCopy(Blocks.CHAIN)));
    FabricRegistrar.RegistryRef<Block>   GOLD_LANTERN           = BCRegistries.BLOCKS.register("gold_lantern",           () -> new LanternBlock        (BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN)));
    FabricRegistrar.RegistryRef<Block>   GOLD_SOUL_LANTERN      = BCRegistries.BLOCKS.register("gold_soul_lantern",      () -> new LanternBlock        (BlockBehaviour.Properties.ofFullCopy(Blocks.SOUL_LANTERN)));
    FabricRegistrar.RegistryRef<Block>   PRINTING_TABLE         = BCRegistries.BLOCKS.register("printing_table",         () -> new PrintingTableBlock  (BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).noOcclusion()));
    FabricRegistrar.RegistryRef<Block>   IRON_PRINTING_TABLE    = BCRegistries.BLOCKS.register("iron_printing_table",    () -> new PrintingTableBlock  (BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion()));
    FabricRegistrar.RegistryRef<Block>   SWORD_PEDESTAL         = BCRegistries.BLOCKS.register("sword_pedestal",         () -> new SwordPedestalBlock  (BlockBehaviour.Properties.ofFullCopy(Blocks.SMOOTH_STONE).noOcclusion()));
    //TODO Map Frame
    //TODO Painting Frame
    //TODO Painting Press
    //TODO Writing Desk
