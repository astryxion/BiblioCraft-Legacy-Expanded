...
public interface BCItems {
    ...
    FabricRegistrar.RegistryRef<Item>  CLEAR_FANCY_GOLD_LAMP = BCRegistries.ITEMS.register(                    "fancy_gold_lamp",    () -> new BlockItem(BCBlocks.CLEAR_FANCY_GOLD_LAMP.get(), PROPERTIES));
    ...
    FabricRegistrar.RegistryRef<Item>  CLEAR_FANCY_IRON_LAMP = BCRegistries.ITEMS.register(                    "fancy_iron_lamp",    () -> new BlockItem(BCBlocks.CLEAR_FANCY_IRON_LAMP.get(), PROPERTIES));
    ...
    FabricRegistrar.RegistryRef<Item>  CLEAR_FANCY_GOLD_LANTERN = BCRegistries.ITEMS.register(                    "fancy_gold_lantern", () -> new BlockItem(BCBlocks.CLEAR_FANCY_GOLD_LANTERN.get(), PROPERTIES));
    ...
    FabricRegistrar.RegistryRef<Item>  SOUL_FANCY_GOLD_LANTERN = BCRegistries.ITEMS.register(               "soul_fancy_gold_lantern", () -> new BlockItem(BCBlocks.SOUL_FANCY_GOLD_LANTERN.get(), PROPERTIES));
    FabricRegistrar.RegistryRef<Item>  CLEAR_FANCY_IRON_LANTERN = BCRegistries.ITEMS.register(                    "fancy_iron_lantern", () -> new BlockItem(BCBlocks.CLEAR_FANCY_IRON_LANTERN.get(), PROPERTIES));
    ...
    FabricRegistrar.RegistryRef<Item>  SOUL_FANCY_IRON_LANTERN = BCRegistries.ITEMS.register(               "soul_fancy_iron_lantern", () -> new BlockItem(BCBlocks.SOUL_FANCY_IRON_LANTERN.get(), PROPERTIES));
    FabricRegistrar.RegistryRef<Item>  CLEAR_TYPEWRITER = BCRegistries.ITEMS.register(                    "typewriter", () -> new BlockItem(BCBlocks.CLEAR_TYPEWRITER.get(), PROPERTIES));
    ...
    FabricRegistrar.RegistryRef<Item>  CLIPBOARD              = BCRegistries.ITEMS.register("clipboard", ClipboardItem::new);
    FabricRegistrar.RegistryRef<Item>  COOKIE_JAR             = BCRegistries.registerSimpleBlockItem(BCBlocks.COOKIE_JAR);
    FabricRegistrar.RegistryRef<Item>  DESK_BELL              = BCRegistries.registerSimpleBlockItem(BCBlocks.DESK_BELL);
    FabricRegistrar.RegistryRef<Item>  DINNER_PLATE           = BCRegistries.registerSimpleBlockItem(BCBlocks.DINNER_PLATE);
    FabricRegistrar.RegistryRef<Item>  DISC_RACK              = BCRegistries.ITEMS.register("disc_rack", () -> new DiscRackItem(new Item.Properties()));
    FabricRegistrar.RegistryRef<Item>  IRON_FANCY_ARMOR_STAND = BCRegistries.ITEMS.register("iron_fancy_armor_stand", () -> new DoubleHighBlockItem(BCBlocks.IRON_FANCY_ARMOR_STAND.get(), PROPERTIES));
    FabricRegistrar.RegistryRef<Item>  GOLD_CHAIN             = BCRegistries.registerSimpleBlockItem(BCBlocks.GOLD_CHAIN);
    FabricRegistrar.RegistryRef<Item>  GOLD_LANTERN           = BCRegistries.registerSimpleBlockItem(BCBlocks.GOLD_LANTERN);
    FabricRegistrar.RegistryRef<Item>  GOLD_SOUL_LANTERN      = BCRegistries.registerSimpleBlockItem(BCBlocks.GOLD_SOUL_LANTERN);
    FabricRegistrar.RegistryRef<Item>  PRINTING_TABLE         = BCRegistries.registerSimpleBlockItem(BCBlocks.PRINTING_TABLE);
    FabricRegistrar.RegistryRef<Item>  IRON_PRINTING_TABLE    = BCRegistries.registerSimpleBlockItem(BCBlocks.IRON_PRINTING_TABLE);
    FabricRegistrar.RegistryRef<Item>  SWORD_PEDESTAL         = BCRegistries.registerSimpleBlockItem("sword_pedestal", BCBlocks.SWORD_PEDESTAL, new Item.Properties().component(DataComponents.DYED_COLOR, SwordPedestalBlock.DEFAULT_COLOR));
    FabricRegistrar.RegistryRef<Item>  BIG_BOOK               = BCRegistries.ITEMS.register("big_book", () -> new BigBookItem(false));
    FabricRegistrar.RegistryRef<Item>  WRITTEN_BIG_BOOK       = BCRegistries.ITEMS.register("written_big_book", () -> new BigBookItem(true));
    FabricRegistrar.RegistryRef<Item>  LOCK_AND_KEY           = BCRegistries.ITEMS.register("lock_and_key", () -> new LockAndKeyItem(new Item.Properties()));
    FabricRegistrar.RegistryRef<Item>  PLUMB_LINE             = BCRegistries.ITEMS.register("plumb_line", () -> new PlumbLineItem(new Item.Properties()));
    FabricRegistrar.RegistryRef<Item>  REDSTONE_BOOK          = BCRegistries.ITEMS.register("redstone_book", () -> new RedstoneBookItem(new Item.Properties().stacksTo(1)));
    FabricRegistrar.RegistryRef<Item>  SLOTTED_BOOK           = BCRegistries.ITEMS.register("slotted_book", () -> new SlottedBookItem(new Item.Properties().stacksTo(1)));
    FabricRegistrar.RegistryRef<Item>  STOCKROOM_CATALOG      = BCRegistries.ITEMS.register("stockroom_catalog", () -> new StockroomCatalogItem(new Item.Properties().stacksTo(1)));
    FabricRegistrar.RegistryRef<Item>  TAPE_MEASURE           = BCRegistries.ITEMS.register("tape_measure", () -> new TapeMeasureItem(new Item.Properties()));
    FabricRegistrar.RegistryRef<Item>  TAPE_REEL              = BCRegistries.registerSimpleItem("tape_reel");
    FabricRegistrar.RegistryRef<Item>  TYPEWRITER_PAGE        = BCRegistries.ITEMS.register("typewriter_page", () -> new TypewriterPageItem(new Item.Properties().stacksTo(1).component(BCDataComponents.TYPEWRITER_PAGE.get(), TypewriterPage.DEFAULT)));
    //TODO Hand Drill
    //TODO Screw Gun
    //TODO Monocle
