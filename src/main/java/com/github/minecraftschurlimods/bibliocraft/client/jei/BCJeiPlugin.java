...
public final class BCJeiPlugin implements IModPlugin {
    ...
    private static final Supplier<BibliocraftWoodType> OAK = () -> BibliocraftApi.getWoodTypeRegistry().get(BCUtil.mcLoc("oak"));
    private static final DyeColor WHITE = DyeColor.WHITE;
    private static final List<WoodTypeDeferredHolder<Item, ?>> WOOD_TYPE_DEFERRED_HOLDERS =
            List.of(BCItems.BOOKCASE, BCItems.FANCY_ARMOR_STAND, BCItems.FANCY_CLOCK, BCItems.FANCY_CRAFTER, BCItems.GRANDFATHER_CLOCK, BCItems.LABEL, BCItems.POTION_SHELF, BCItems.SHELF, BCItems.TABLE, BCItems.TOOL_RACK);
    private static final List<ColoredDeferredHolder<Item, ?>> COLORED_DEFERRED_HOLDERS =
            List.of(BCItems.FANCY_GOLD_LAMP, BCItems.FANCY_IRON_LAMP, BCItems.FANCY_GOLD_LANTERN, BCItems.FANCY_IRON_LANTERN);
    private static final List<ColoredWoodTypeDeferredHolder<Item, ?>> COLORED_WOOD_TYPE_DEFERRED_HOLDERS =
            List.of(BCItems.DISPLAY_CASE, BCItems.SEAT, BCItems.SMALL_SEAT_BACK, BCItems.RAISED_SEAT_BACK, BCItems.FLAT_SEAT_BACK, BCItems.TALL_SEAT_BACK, BCItems.FANCY_SEAT_BACK);
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        if (!BCConfig.JEI_SHOW_WOOD_TYPES) {
            for (WoodTypeDeferredHolder<Item, ?> holder : WOOD_TYPE_DEFERRED_HOLDERS) {
                registration.addIngredientInfo(holder.get(OAK.get()), Translations.ALL_WOOD_TYPES);
            }
        }
        if (!BCConfig.JEI_SHOW_COLOR_TYPES) {
            if (!BCConfig.JEI_SHOW_WOOD_TYPES) {
                for (ColoredWoodTypeDeferredHolder<Item, ?> holder : COLORED_WOOD_TYPE_DEFERRED_HOLDERS) {
            ...
            for (ColoredDeferredHolder<Item, ?> holder : COLORED_DEFERRED_HOLDERS) {
