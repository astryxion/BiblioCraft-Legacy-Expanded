...
public final class LockAndKeyBehaviorsImpl implements LockAndKeyBehaviors {
    ...
    public void register() {
        // NeoForge: ModLoader.postEvent(new RegisterLockAndKeyBehaviorEvent(values));
        // Fabric: call registerForFabric() from BCEventHandlerFabric instead.
        registerForFabric();
    }

    /** Called from Fabric init to run registration without the event bus. */
    @ApiStatus.Internal
    public void registerForFabric() {
        com.github.minecraftschurlimods.bibliocraft.fabric.BCEventHandlerFabric.registerLockAndKeyBehaviors(new RegisterLockAndKeyBehaviorEvent(values));
        loaded = true;
    }
