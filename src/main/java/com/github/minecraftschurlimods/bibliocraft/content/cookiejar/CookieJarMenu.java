...
public class CookieJarMenu extends BCMenu<CookieJarBlockEntity> {
    public CookieJarMenu(int id, PlayerInventory inventory, CookieJarBlockEntity blockEntity) {
        super(BCMenus.COOKIE_JAR.get(), id, inventory, blockEntity);
        blockEntity.startOpen(inventory.player);
    }

    public CookieJarMenu(int id, PlayerInventory inventory, PacketBuffer buf) {
