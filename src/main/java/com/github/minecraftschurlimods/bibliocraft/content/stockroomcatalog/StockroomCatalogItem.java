...
public class StockroomCatalogItem extends Item {
    ...
    public StockroomCatalogItem(Properties properties) {
        super(properties.component(DataComponents.MAX_STACK_SIZE, 1).component(BCDataComponents.STOCKROOM_CATALOG_CONTENT.get(), StockroomCatalogContent.DEFAULT));
    }
    ...
    public static List<BlockPos> calculatePositions(ItemStack stack, Level level, Player player, StockroomCatalogSorting.Container containerSorting) {
        ...
        return stack.getOrDefault(BCDataComponents.STOCKROOM_CATALOG_CONTENT.get(), StockroomCatalogContent.DEFAULT)
                .positions()
                .stream()
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (player != null && context.isSecondaryUseActive()) {
            ...
            StockroomCatalogContent list = stack.getOrDefault(BCDataComponents.STOCKROOM_CATALOG_CONTENT.get(), StockroomCatalogContent.DEFAULT);
