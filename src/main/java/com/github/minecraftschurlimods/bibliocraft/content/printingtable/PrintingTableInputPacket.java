...
public record PrintingTableInputPacket(BlockPos pos, Optional<PrintingTableMode> mode, Optional<Integer> experience) {
    ...
    public static PrintingTableInputPacket decode(FriendlyByteBuf buf) {
