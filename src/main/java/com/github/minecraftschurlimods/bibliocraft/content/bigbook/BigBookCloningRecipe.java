...
public class BigBookCloningRecipe extends CustomRecipe {
    ...
    public ItemStack assemble(CraftingInput input, HolderLookup.Provider registries) {
        ...
        WrittenBigBookContent content = stack.get(BCDataComponents.WRITTEN_BIG_BOOK_CONTENT.get());
        ...
        result.set(BCDataComponents.WRITTEN_BIG_BOOK_CONTENT.get(), contentCopy);
        return result;
    }
