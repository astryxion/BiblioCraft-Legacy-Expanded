...
public class CookieJarBlockEntity extends BCMenuBlockEntity {
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onClose(Level level, BlockPos pos, BlockState state) {
            ...
            // Resend BE data at end of tick so client BER gets items after block state update (client may recreate BE).
            ContainerSyncScheduler.schedule(CookieJarBlockEntity.this);
        }
