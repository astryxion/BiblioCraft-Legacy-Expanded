    ...
    protected void init() {
        ...
        if (isSigning) {
            ...
            for (int i = 0; i < colors.length; i++) {
                ...
                ColorButton button = addRenderableWidget(new ColorButton(colors[i].getColor(), rightX + 80 - 16 * (4 - i % 4), 80 + 16 * Math.floorDiv(i, 4), 16, 16, Component.translatable("color." + colors[i].getName()), $ -> setColor(colors[j].getColor())));
