...
import at.minecraftschurli.mods.bibliocraft.util.Lazy;
...
public final class BCJeiPlugin implements IModPlugin {
    ...
    public void onRuntimeAvailable(IJeiRuntime runtime) {
        ...
        runtime.getIngredientManager().removeIngredientsAtRuntime(FabricTypes.FLUID_STACK, List.of(new JeiFluidIngredient(FluidVariant.of(BCFluids.EXPERIENCE.get()), 1000)));
    }
