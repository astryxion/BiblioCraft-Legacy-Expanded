...
public class ClockTriggerElement extends Screen {
    ...
    public ClockTriggerElement(ClockTrigger trigger, ClockTriggerPanel owner, int listSize) {
        ...
        editButton = addRenderableWidget(new SpriteButton.RegularAndHighlightSprite(EDIT, EDIT_HIGHLIGHTED, width - 34, 2, 16, 16, $ -> ClientUtil.getMc().setScreen(new ClockTriggerEditScreen(owner.owner, trigger))));
