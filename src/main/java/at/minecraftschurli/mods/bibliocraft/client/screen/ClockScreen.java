...
public class ClockScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(Button.builder(Translations.CLOCK_ADD_TRIGGER, $ -> minecraft.gui.setScreen(new ClockTriggerEditScreen(this, null)))
    ...
    @Override
    public void onClose() {
        ClientPlayNetworking.send(new ClockSyncPacket(pos, tickSound.selected(), triggers));
        super.onClose();
    }
