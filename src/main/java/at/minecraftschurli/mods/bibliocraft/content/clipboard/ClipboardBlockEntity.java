...
public class ClipboardBlockEntity extends BlockEntity {
    ...
    protected void applyImplicitComponents(DataComponentGetter componentGetter) {
        ...
        setContent(componentGetter.getOrDefault(BCDataComponents.CLIPBOARD_CONTENT.get(), ClipboardContent.DEFAULT));
    }
    ...
    protected void collectImplicitComponents(DataComponentMap.Builder components) {
        ...
        if (!content.equals(ClipboardContent.DEFAULT)) {
            components.set(BCDataComponents.CLIPBOARD_CONTENT.get(), content);
        }
    }
